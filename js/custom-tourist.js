    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.returnCode === 0) {
                ...
                $('.main-href-id').attr('href', 'blog_detail.html?type=travel&id=' + novel.mainNovel.id);
                ...
                $.each(novel.novels, function (index, value) {
                    ...
                    tmp += '<p>' + value.brief + '</p>';
                    tmp += '<a class="btn btn-info btn-novel" href="blog_detail.html?type=travel&id=' + value.id + '">More</a>';
                    tmp += '</div></div></div>';
                    htmlStr += tmp;
                });
